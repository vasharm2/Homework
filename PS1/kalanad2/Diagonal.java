...
public class Diagonal {
	...
	public static int diagonal(int[][] input) {
		int sumMainD=0;
		for(int ctr=0;ctr<input.length;sumMainD+=input[ctr][ctr],ctr++);
		int sumOtherD=0;
		for(int ctr=0;ctr<input.length;sumOtherD+=input[input.length-ctr-1][ctr],ctr++);
		return sumMainD*sumOtherD;
	}
