...
*/
'''
multipy by diagonals
(1,1 + 2,2 + 3,3 ) * (1,1.lentgh-1 + 2,2 , 3,1)
how can you set this up with out knowing what dimension array it is?
'''
public class Diagonal {

	public static int diagonal(int[][] input) {
		([1][0] + [n][n] + [n][n.length-1])
    ([1][1.length-1] + [n][n] + [n][1])
