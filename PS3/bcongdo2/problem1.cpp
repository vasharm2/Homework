...
int main() {
    ...
    //Setting the value of str2 to the address of temp
	string *str2 = &temp;
	string temp2 = "and this is the third part";
    //Setting the value of str3 to the address of temp2
	string *str3 = &temp2;
    ...
    //Concatonate str1 with the value pointed to by str2 and str3
