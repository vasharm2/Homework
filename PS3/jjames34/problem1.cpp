...
int main() {
	...
	string *str2 = &temp;
	//Assigning a variable that is of type "pointer" to the memory location of the string temp.
	string temp2 = "and this is the third part";
	string *str3 = &temp2;
	//Assigning a variable that is of type "pointer" to the memory location of the string temp2.
