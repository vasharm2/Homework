...
int main() {
	...
	string str1 = "This is the first part, ";// type cannont be a pointer 
	string temp = "this is the second part, ";//must assign a string to a variable, not a pointer
	string *str2 = &temp;//must assign a reference to a pointer  
	string temp2 = "and this is the third part";
	string *str3 = &temp2;//pointer must be assinged reference to a string




	string str6 = str1 + *str2 + *str3;//must dereference str2 and str3 because they are pointers.
