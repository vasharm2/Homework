...
int main() {
    ...
    *pointer3 = address2;
    pointer3 = pointer2;
    *pointer2 = address3; // Unmodified, this completely overwrites the string 'correct output' in memory. Was that what you were going for?
    // cout << address3 + address2 + *pointer2 + *pointer3 << endl;
