...
int main() {
	...
	const string *str1 = "This is the first part, ";
	const string *temp = "this is the second part, ";
	const string *str2 = temp;
	const string *temp2 = "and this is the third part";
	const string *str3 = temp2;
	...
	string *str6 = new string(str1 + str2 + str3);
