...
/*** BEGIN CHALLENGE (method parameter and body modifications only) ***/
void setString(string& address2, string address3) {
	// since we are now passing in the strings by reference,
	// we can just assign address2 to the value that we want
	address2 = address3;
	return;
}
/*** END CHALLENGE ***/
